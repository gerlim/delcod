...
import 'package:barcode_app/legacy/features/collections/application/collections_controller.dart';
import 'package:barcode_app/legacy/features/collections/data/collections_repository.dart';
import 'package:barcode_app/legacy/features/collections/domain/collection_status.dart';
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 10),
                                    Text(
                                      'Criada por ${item.createdBy} â€¢ Empresa ${item.companyId}',
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyMedium
                                          ?.copyWith(
